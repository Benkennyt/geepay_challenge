import { ArrowRightIcon, BoxIcon, BulkIcon, CloseIcon, DiscountShapeIcon, InfoCircleIcon, LogOutIcon, Logo, Profile2userIcon, SettingsIcon, TrendUpIcon, VectorIcon } from '../../../assets/SVG'
import Switch from '../../../general/Switch'
import './Sidebar.css'

const Sidebar = (props: any) => {
    const {isToggled, setIsToggled,toggleSideBar, setToggleSideBar, handleFocusedPageButton, focused} = props
  return (
